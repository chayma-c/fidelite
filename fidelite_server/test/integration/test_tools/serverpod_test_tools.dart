...
import 'package:fidelite_server/src/generated/points/points_ledger_entry.dart'
    as _i9;
import 'package:fidelite_server/src/generated/users/app_user.dart' as _i10;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    pointsClaim = _PointsClaimEndpoint(
      endpoints,
      serializationManager,
    );
...
class _MenuEndpoint {
  ...
  _i3.Future<List<_i4.MenuItemRecord>> getMenu(
...
class _OrderEndpoint {
  ...
  _i3.Future<List<_i7.OrderRecord>> getOrderHistory(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _PointsClaimEndpoint {
  _PointsClaimEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i8.ClaimResult> claimOrderPoints(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'pointsClaim',
            method: 'claimOrderPoints',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'pointsClaim',
          methodName: 'claimOrderPoints',
          parameters: _i1.testObjectToJson({
            'orderId': orderId,
            'token': token,
          }),
...
class _WalletEndpoint {
  ...
  _i3.Future<int> getBalance(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'wallet',
  ...
  _i3.Future<List<_i9.PointsLedgerEntryRecord>> getPointsHistory(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i9.PointsLedgerEntryRecord>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _UserEndpoint {
  ...
  _i3.Future<_i10.AppUserRecord> getMe(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i10.AppUserRecord>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
